...
def run_blackbody(n_vertices: int):
    ...
    i_bb = simulate_observed_flux(bb.intensity, model, jnp.log10(vws), 10., chunk_size=1000, disable_doppler_shift=True)
...
if __name__ == '__main__':
    ...
    pd.DataFrame.from_records(vertex_data).to_csv('blackbody_luminosity.csv', index=False)
