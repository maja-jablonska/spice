...
class TestMeshTransformations:
    ...
    def test_pulsation_functions(self, mesh_model):
        ...
        fourier_series_static_parameters = jnp.array([1])
        fourier_series_parameters = jnp.array([1])
        pulsated_mesh = add_pulsation(mesh_model, spherical_harmonics_parameters, fourier_series_static_parameters,
